...
int main() {
    ...
    while (t--) {
           ...
           cinData(v,n);
           bool b1 = true;
            while(v.size()<20) v.push_back(1001);


           if(v[2]>v[3]) b1=false;
           if(v[4]>v[5] || v[5]>v[6] || v[6]>v[7]) b1=false;
           if(v[8]>v[9] || v[9]>v[10] || v[10]>v[11] ||v[11]>v[12] || v[12]>v[13] || v[13]>v[14]|| v[14]>v[15]) b1= false;
           if(v[16]>v[17] || v[17]>v[18] || v[18]>v[19]) b1=false;
